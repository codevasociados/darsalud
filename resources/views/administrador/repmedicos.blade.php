              ...
              <tbody>
                <tr>
                  @foreach ($usuario as $user)
                    ...
                    <td><button type="button" title="Detalles" class="btn btn-warning" name="button">
                    ...
                    <td><button type="button" title="Detalles" class="btn btn-info" name="button">
                      <span style="font-size: 18px;"><?php
                    ...
                    <td><button type="button" title="Detalles" class="btn btn-danger" name="button">
                      <span style="font-size: 18px;"><?php
